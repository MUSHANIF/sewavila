...
<form action="{{ url('jns') }}" method="GET" class="app-search position-absolute">
...
<div class="col-6">
    <div class="text-end upgrade-btn">
        <a href="{{ route('jns.create') }}" class="btn btn-primary text-white"
                >Tambah</a>
    </div>
</div>
@endsection
    ...
    <table class="table mt-3" cellpadding="10" cellspace="0">
        ...
        <tbody>
            <tr class="align-self-center text-center"  style="border: 1px solid black;">
                ...
                <td data-label="">{{ $key->jenis }}</td>
               
                 <td class="text-center justify-content-center align-self-center d-flex">
                    
                    {{-- <a class="btn btn-info" href="{{ route('jns.edit',$key->id)}}">Ubah</a> --}}
